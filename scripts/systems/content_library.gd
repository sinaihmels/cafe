...
const CARD_PATHS: Array[String] = [
	...
	"res://data/cards/starter_tomato_sauce.tres",
	"res://data/cards/starter_vanilla.tres",
	"res://data/cards/starter_strawberry.tres",
	"res://data/cards/starter_lemon.tres",
	"res://data/cards/starter_butter.tres",
	"res://data/cards/starter_sugar_glaze.tres",
	"res://data/cards/starter_egg_wash.tres",
	"res://data/cards/starter_double_batch.tres",
	"res://data/cards/starter_mini_cookies.tres",
	"res://data/cards/starter_small_talk.tres",
	"res://data/cards/starter_perfect_timing.tres",
