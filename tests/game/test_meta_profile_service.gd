...
func _init() -> void:
	...
	assert(meta.profile_state.unlocked_dough_ids.has(&"savory_dough"), "Savory Dough should be unlocked by default.")
	assert(meta.profile_state.unlocked_dough_ids.has(&"laminated_dough"), "Laminated Dough should be unlocked by default.")
	assert(meta.profile_state.unlocked_dough_ids.has(&"sourdough"), "Sourdough should be unlocked by default.")
